    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            foreach (var item in people)
            {
                ...
                var p = Activator.CreateInstance(t, new object[] { "xiaohong", 1 }) as Person;
                Console.WriteLine(p.Name);
                //var obj = 
            }

            //GetTypesFromAssembly(@"C:\Program Files (x86)\Reference Assemblies\Microsoft\Framework\.NETFramework\v4.7.2\System.dll");
            Console.ReadLine();
        }
